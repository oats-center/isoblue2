...
consumer = KafkaConsumer("ibeng", auto_offset_reset="earliest", group_id=None)
#consumer = KafkaConsumer("ibeng")
...
for msg in consumer:
    ...
    #parsed_message = p.parse_message(message, user1["timestamp"])
